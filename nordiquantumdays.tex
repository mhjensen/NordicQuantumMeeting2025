...
\column{6cm}
      \begin{center}
	\includegraphics[width=0.65\textwidth]{qcfigures/entanglement.pdf}
      \end{center}
\end{columns}
      \end{footnotesize}
    }
...
\column{6cm}
      \begin{center}
	\includegraphics[width=0.65\textwidth]{qcfigures/coeffs.pdf}
      \end{center}
\end{columns}
      \end{footnotesize}
    }
...
\column{6cm}
      \begin{center}
	\includegraphics[width=0.65\textwidth]{qcfigures/probability.pdf}
      \end{center}
\end{columns}
      \end{footnotesize}
    }
